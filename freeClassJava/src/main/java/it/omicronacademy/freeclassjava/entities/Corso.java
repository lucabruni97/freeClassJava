...
public class Corso {
    ...
    @JoinTable(
            name = "studente_corso",
            joinColumns = @JoinColumn(name = "idCorso"),
            inverseJoinColumns = @JoinColumn(name = "idStudente")
    )
    ...
    public boolean equals(Object o) {
        ...
        Corso corso = (Corso) o;
        return Objects.equals(id, corso.id) && Objects.equals(titolo, corso.titolo) && Objects.equals(descrizione, corso.descrizione) && Objects.equals(dataInizio, corso.dataInizio) && Objects.equals(dataFine, corso.dataFine) && Objects.equals(studenti, corso.studenti);
    }
